...
{_box addBackpackCargoGlobal [_x, 5];} forEach _backpacks;
{_box addWeaponCargoGlobal [_x, 50];} forEach _inventory;
{_box addMagazineCargoGlobal [_x, 100];} forEach _items;
{_box addMagazineCargoGlobal [_x, 10];} forEach _skins;
{_box addWeaponCargoGlobal [_x, 20];} forEach _weapons;
{_box addMagazineCargoGlobal [_x, 100];} forEach _ammo;
{_box addMagazineCargoGlobal [_x, 100];} forEach _explosives;
