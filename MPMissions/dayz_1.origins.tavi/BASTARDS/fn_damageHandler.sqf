...
if (_damage > 0.4) then {
	...
	//Cause blood loss
	//Log Damage
	if (_weapon == "BAF_AS50_scoped") then { _scale = _scale / 3.8; _damage = _damage / 5.2; };
	diag_log ("DAMAGE: player hit by " + typeOf _source + " in " + _hit + " with " + _ammo + " for " + str(_damage) + " scaled " + str(_damage * _scale) + "_type=" + str(_type) + "_scale=" + str(_scale) + "_weapon=" + str(_weapon));
	r_player_blood = r_player_blood - (_damage * _scale);
	};
	...
	//Cause blood loss
	//Log Damage
	if (_weapon == "BAF_AS50_TWS") then { _scale = _scale / 3.8; _damage = _damage / 5.2; };
	diag_log ("DAMAGE: player hit by " + typeOf _source + " in " + _hit + " with " + _ammo + " for " + str(_damage) + " scaled " + str(_damage * _scale) + "_type=" + str(_type) + "_scale=" + str(_scale) + "_weapon=" + str(_weapon));
	r_player_blood = r_player_blood - (_damage * _scale);
	};
	...
	//Cause blood loss
	//Log Damage
	if (_weapon == "M107") then { _scale = _scale / 3.8; _damage = _damage / 5.2; };
	diag_log ("DAMAGE: player hit by " + typeOf _source + " in " + _hit + " with " + _ammo + " for " + str(_damage) + " scaled " + str(_damage * _scale) + "_type=" + str(_type) + "_scale=" + str(_scale) + "_weapon=" + str(_weapon));
	r_player_blood = r_player_blood - (_damage * _scale);
	};
	...
	//Cause blood loss
	//Log Damage
	if (_weapon == "M107 TWS") then { _scale = _scale / 3.8; _damage = _damage / 5.2; };
	diag_log ("DAMAGE: player hit by " + typeOf _source + " in " + _hit + " with " + _ammo + " for " + str(_damage) + " scaled " + str(_damage * _scale) + "_type=" + str(_type) + "_scale=" + str(_scale) + "_weapon=" + str(_weapon));
	r_player_blood = r_player_blood - (_damage * _scale);
	};
