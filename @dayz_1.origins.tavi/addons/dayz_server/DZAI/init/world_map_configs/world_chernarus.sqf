...
_this = createTrigger ["EmptyDetector", [12101.592, 12710.504]];
_this setTriggerArea [600, 600, 0, false];
_this setTriggerActivation ["ANY", "PRESENT", true];
_this setTriggerTimeout [10, 15, 20, true];
_this setTriggerText "NEAF (Markers)";
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [2,2,250,thisTrigger,['NEAF1','NEAF2','NEAF3','NEAF4','NEAF5'],2] call fnc_spawnBandits;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_56 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [3,1,175,thisTrigger,[],3,2] call fnc_spawnBandits;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_68 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [3,1,200,thisTrigger,[],3,2] call fnc_spawnBandits;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_70 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [1,2,200,thisTrigger,['Elektro1','Elektro2','Elektro3','Elektro4','Elektro5'],0] call fnc_spawnBandits;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_156 = _this;
